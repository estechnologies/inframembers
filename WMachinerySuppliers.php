...
needed….</p><br><p style="font-size:16px;" ><b>The following Machinery Suppliers are available for you………….</b></p>
 <center></center>
 <center><?php 
  ...
  <center class="message"> <label style="font-size: 14px;color:Red;"><?php echo $msg;?></label></center> 
   ...
   <center class="message"> <label style="font-size: 14px;color:green;"><?php echo $msg1;?></label></center>
		 ...
		 <?php	
							...
							$query = "SELECT * FROM profile WHERE macsuppost='1' LIMIT $pageNumber,5 ";
...
$resultQuery = mysql_query($query);
							...
							$pagesTotalCount = "SELECT * FROM profile WHERE macsuppost='1'";
...
<center>
        <div class="span12">
              <form method="post" action="WMachinerySuppliers.php" class="form-inline" >
			...
			<thead>
			  <tr>
								 ...
								 <th ><strong>Available Machinery</strong></th> 
			 ...
			 <?php
			 	...
			 	while($row = mysql_fetch_array($resultQuery)){ ?>
							<tr>
								 ...
								 <td><?php echo $row['macsupmachinery'];?></td>
								 <td><?php echo $row['macsupdescription'];?></td> 
								<td><?php echo $row['location'];?></td>
								 <td><?php echo $row['number'];?></td> 
								  <td><a href="<?php echo $row['subconprofile'];?>">Profile</a></td> 
        ...
        <!--
            ...
            <?php 
            	...
            	for($i = 1;$i <= $pageCount; $i++){
            		?>  <li><a href="WMachinerySuppliers.php?page=<?php echo $i;?>"><?php  echo $i; ?></a></li> <?php 
            	}
