...
needed….</p><br><p style="font-size:16px;" ><b>The following Contractors are available for you………….</b></p>
 <center><?php 
  ...
  <center class="message"> <label style="font-size: 14px;color:Red;"><?php echo $msg;?></label></center> 
   ...
   <center class="message"> <label style="font-size: 14px;color:green;"><?php echo $msg1;?></label></center>
		 ...
		 <?php	
							...
							$query = "SELECT * FROM profile WHERE subconpost='1' LIMIT $pageNumber,5 ";
...
$resultQuery = mysql_query($query);
							...
							$pagesTotalCount = "SELECT * FROM profile WHERE subconpost='1' ";
     ...
     <center>   <div class="span12">
              <form method="post" action="WContrators.php" class="form-inline" >
			 ...
			 <?php
			 	...
			 	while($row = mysql_fetch_array($resultQuery)){ ?>
							<tr>
								 ...
								 <td><?php echo $row['subconspec'];?></td>
                                                                 <td><?php echo $row['subcondes']?>
        ...
        <!--
            ...
            <?php 
            	...
            	for($i = 1;$i <= $pageCount; $i++){
            		?>  <li><a href="WContrators.php?page=<?php echo $i;?>"><?php  echo $i; ?></a></li> <?php 
            	}
