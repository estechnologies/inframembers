...
<html>
<head>
<title>Material Supplier Infra Members</title>
 <meta charset="utf-8" />
...
<center>
        <div class="span12">
              <form method="post" action="MaterialSupplier.php" class="form-inline" >
        ...
        <!--
            ...
            <?php 
            	...
            	for($i = 1;$i <= $pageCount; $i++){
            		?>  <li><a href="MaterialSupplier.php?page=<?php echo $i;?>"><?php  echo $i; ?></a></li> <?php 
            	}
...
<footer style="margin-bottom:0px" class="navbar navbar-fixed-bottom footerbottom">
		...
		<div class="col-md-12" style="text-align:center;">
			<center>     <p style="margin-top:10px;" class="footer">All Rights Reserved - 2016. <a target="t-blank" href="http://inframembers.com">Infra Members</a></p></center>
		</div>
   </footer>
</body>
</html>